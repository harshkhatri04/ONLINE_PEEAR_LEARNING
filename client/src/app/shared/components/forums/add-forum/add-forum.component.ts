...
export class AddForumComponent implements OnInit, AfterViewInit, OnDestroy {
...
forumConfig=forumConfig;
 ...
 ngOnDestroy(){
    CKEDITOR.instances.problemDescription.destroy();
    CKEDITOR.instances.addSnippet.destroy();
 }
